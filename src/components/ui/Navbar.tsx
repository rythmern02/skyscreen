        ...
        >
          ...
          <nav
            className={cn(
              ...
              scrolled
                ? "border-line bg-coal/70 backdrop-blur-xl"
          ...
          >
            {NAV_LINKS.map((l) => (
              <a
                ...
                className="relative rounded-full px-4 py-2 text-sm text-haze/70 transition-colors hover:text-fg"
              >
                {l.label}
              </a>
            ))}
          ...
          <div className="relative z-10 flex items-center gap-2 lg:hidden">
            ...
            <button
              ...
              onClick={() => setOpen((v) => !v)}
              className="flex h-11 w-11 flex-col items-center justify-center gap-[5px] rounded-full border border-line bg-coal/60 backdrop-blur-xl"
            >
              <span
                className={cn(
                  "h-px w-4 bg-fg transition-all duration-300",
            ...
            <nav className="flex flex-col gap-2">
              {NAV_LINKS.map((l, i) => (
                <motion.a
                  ...
                  className="font-display text-4xl tracking-tight text-fg/90"
                >
                  {l.label}
                </motion.a>
              ))}
